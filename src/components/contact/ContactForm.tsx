  ...
  return (
    <div className="bg-onyx border border-border-subtle rounded-2xl p-8 lg:p-12 relative overflow-hidden">
      ...
      {submitStatus === 'success' ? (
        <div role="status" aria-live="polite" className="flex flex-col items-center justify-center h-full text-center space-y-6 relative z-10 animate-[fade-up_0.5s_ease_forwards]">
        ...
        <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div>
              <label htmlFor="first_name" className="block text-[0.65rem] uppercase tracking-widest text-stone mb-2">First Name</label>
              <input 
                id="first_name"
                name="first_name" 
                type="text" 
            ...
            <div>
              <label htmlFor="last_name" className="block text-[0.65rem] uppercase tracking-widest text-stone mb-2">Last Name</label>
              <input 
                id="last_name"
                name="last_name" 
                type="text" 
          ...
          <div>
            <label htmlFor="email" className="block text-[0.65rem] uppercase tracking-widest text-stone mb-2">Email Address</label>
            <input 
              id="email"
              name="email" 
              type="email" 
          ...
          <div>
            <label htmlFor="message" className="block text-[0.65rem] uppercase tracking-widest text-stone mb-2">How can we help?</label>
            <textarea 
              id="message"
              name="message" 
              rows={4} 
          ...
          <button 
            ...
            className="w-full bg-gold hover:bg-gold-light text-void font-bold text-[0.75rem] uppercase tracking-[0.1em] py-4 rounded-md transition-all hover:shadow-[0_4px_20px_rgba(201,149,42,0.3)] hover:-translate-y-0.5 disabled:opacity-50 disabled:cursor-not-allowed disabled:translate-y-0 flex items-center justify-center gap-2"
          >
            {isSubmitting ? (
              <>
          ...
          {submitStatus === 'error' && (
            <p role="alert" className="text-bear text-[0.7rem] text-center mt-2 animate-pulse">
