...
export default function ScreenerPanel() {
  ...
  // Performance optimization: Debounce search input changes by 300ms to avoid firing
  // rapid API network requests and upstream server queries on every keystroke.
  useEffect(() => {
